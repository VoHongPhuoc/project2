...
<div style="width: 210px;height: 278px;margin: 0 20px;margin-left: 0px;float: left;">
	<li>
		...
		<a style="margin-left: 10px" href="dienthoai.php?tt=add2&matt2=<?php echo $rows['id'];?>"><input type="submit" name="" value="Mua" style="background:#A4A4A4;width: 60px;height: 23px;border-radius: 5px;margin-top: 5px;border: solid 1px black;"></a>
		<a style="margin-left: 10px" href="dienthoai.php?tt=chitiet&id=<?php echo $rows['id'];?>"><input type="submit" name="" value="Trả góp" style="background: #A4A4A4;width: 60px;height: 23px;border-radius: 5px;margin-top: 5px;border: solid 1px black;"></a>
	</li>
</div>	
<?php 
	}
